...
function PiuAction({ iconType, icon, actionCount, size, active, onPress, verticalIconDisplacement, horizontalIconDisplacement, noMargin=false, activeColor="#FF0800" }) {
    return (
